...
>      - **Phase 2 — Usecases & Core Business Services**: Encapsulate all business logic, AI interactions, workflows, database/storage operations, and orchestration in dedicated Use Cases or Service classes (`lib/`, `services/`, `.agents/features/`, `app/_/services/`). Follow Singleton + Dependency Injection (Rule 39).
...
| **Usecases & Services** | `Packages/Bots/lib/`, `Packages/Bots/.agents/features/` | Core logic, bot orchestrators, Docker managers, sensor collectors. Rule 39 (Singleton + DI). |
