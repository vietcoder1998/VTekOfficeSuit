...
> **ZERO TOLERANCE**:
> Across all Next.js projects in the 2-TEK workspace (`Packages/LowcodeStudio`, `Packages/Office`, `Packages/Bots`, `Packages/Cloud`, `Packages/DeviceFarms`, `Packages/CompanyWeb`, `Packages/SuperChat`, `Packages/SystemAdmin`, etc.) and whenever scaffolding, initializing, or developing new Next.js projects:
