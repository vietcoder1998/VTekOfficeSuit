...
> **ZERO TOLERANCE**:
> When any task, feature, bug fix, refactor, UI improvement, or configuration change is completed or marked "done" across any 2-TEK project (`bot`, `LowcodeStudio`, `Office`, `SuperChat`, etc.):
