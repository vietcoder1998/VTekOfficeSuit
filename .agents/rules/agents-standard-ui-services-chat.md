...
> 1. **MANDATORY 100% CONFORM TO `.lowcode/.standards/Agents/`**:
...
1. **Full-Stack Chat Directives**:
   - Enables users to request both UI alterations (*"Update checkout button to primary and open payment modal"*) and backend alterations (*"Create orders-service with Stripe controller"*) through structured AI actions.
