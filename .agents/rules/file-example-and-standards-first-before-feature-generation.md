...
>    - The formal schema (JSON Schema, TypeScript interfaces/types, data contracts) and specifications in `.standards/` (or `.lowcode/.standards/MCP/schemas/`) must be updated and verified to rigorously govern the file structure.
...
│ • Update .standards/, TypeScript interfaces, JSON Schemas   │
└────────────────────────┬────────────────────────────────────┘
                         │
                         ▼
┌─────────────────────────────────────────────────────────────┐
