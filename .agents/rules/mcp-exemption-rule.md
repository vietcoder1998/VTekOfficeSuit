...
>      - **STRICTLY PROHIBITED**: Adding new actions to `.lowcode/.standards/MCP/actions.json`.
>      - **STRICTLY PROHIBITED**: Creating new JSON Schemas in `.lowcode/.standards/MCP/schemas/`.
>      - **STRICTLY PROHIBITED**: Creating new Templates in `.lowcode/.standards/MCP/templates/`.
>      - **STRICTLY PROHIBITED**: Creating new Sections in `.lowcode/.standards/MCP/standard-specification.md`.
...
| **Move / Rename Folder (di chuyển folder)** | Move `.lowcode/Example` to `.example`, rename assets | ❌ **NO (DO NOT IMPLEMENT)** | Skip MCP. Move folder, update scanners/loaders, verify fallbacks. |
