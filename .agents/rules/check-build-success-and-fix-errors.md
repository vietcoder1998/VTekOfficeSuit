...
> **ZERO TOLERANCE**:
> When completing any feature, bug fix, refactor, config update, Dockerfile edit, dependency upgrade, or code modification across all projects (`bot`, `LowcodeStudio`, `Office`, `CompanyWeb`, `server`, `web`):
