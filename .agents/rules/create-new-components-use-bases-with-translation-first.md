...
> **ZERO TOLERANCE**:
> When creating, generating, scaffolding, or authoring any new component, interface (`.tsx`), modal, card, panel, dialog, form, button, list, layout, or UI element across all 2-TEK projects (`Office`, `LowcodeStudio`, `Bots`, `SuperChat`, `OfficePack`, `Cloud`, `DeviceFarms`, `Lowcode`, `Server`):
