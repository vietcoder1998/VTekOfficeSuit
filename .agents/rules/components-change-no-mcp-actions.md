...
>    - **FORBIDDEN** to add new actions to `.lowcode/.standards/MCP/actions.json`.
>    - **FORBIDDEN** to create new JSON Schemas in `.lowcode/.standards/MCP/schemas/`.
>    - **FORBIDDEN** to create new Templates in `.lowcode/.standards/MCP/templates/`.
>    - **FORBIDDEN** to write new Sections in `.lowcode/.standards/MCP/standard-specification.md`.
