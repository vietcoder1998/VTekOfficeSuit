...
<!-- Rule Conformance: Rule 13, 14, 18, 20, 21, 60, 64, 68 -->
...
## 2. Visual Design Philosophy & IDE Themes
...
## 4. Typography & High-Density Standards
...
## 5. Zero Inline Styles Policy (Rule 18 & Rule 20)
...
## 6. Iconography Standard: 100% @Shared Icons (Rule 14 & Rule 56)
...
## 7. Default Semantic IDs (Rule 13)
...
## 8. Multilingual Support & Localization (Rule 21 & Rule 54/55)
